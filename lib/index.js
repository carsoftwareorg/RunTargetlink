...
const matlab = __importStar(require("./matlab_run_command/matlab"));
const script = __importStar(require("./script"));
const params = __importStar(require("./options"));
/**
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield core.group("Run command", () => __awaiter(this, void 0, void 0, function* () {
            yield matlab.runCommand(helperScript, platform, exec.exec);
        }));
    });
}
run().catch((e) => {
